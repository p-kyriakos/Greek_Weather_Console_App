...
* **Interactive Loop:** Allows users to perform multiple continuous queries until typing `ÔÅËÏÓ` to exit.
...
```bash
git clone https://github.com/p-kyriakos/Greek_Weather_Console_App.git
```
...
1. Once the application starts, type the name of any Greek city (e.g., ÁèÞíá, Èåóóáëïíßêç) and press Enter to see the live weather data.
2. To exit the interactive loop and close the application, simply type ÔÅËÏÓ.
